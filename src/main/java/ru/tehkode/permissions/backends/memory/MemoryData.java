...
public class MemoryData implements PermissionsGroupData, PermissionsUserData {
	...
	public List<String> getPermissions(String worldName) {
		return worldsPermissions.containsKey(worldName) ? worldsPermissions.get(worldName) : Collections.<String> emptyList();
	}
	...
	public String getOption(String option, String worldName) {
		if (worldsOptions.containsKey(worldName)) {
			...
			if (worldOption.containsKey(option)) return worldOption.get(option);
		}
		return null;
	}
	...
	public Map<String, String> getOptions(String worldName) {
		return worldsOptions.containsKey(worldName) ? worldsOptions.get(worldName) : Collections.<String, String> emptyMap();
	}
