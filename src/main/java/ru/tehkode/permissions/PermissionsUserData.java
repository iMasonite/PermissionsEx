...
public interface PermissionsUserData extends PermissionsData {
	/** Sets the name of the user If a user already exists with this name, nothing will happen. Only
	 * supported for users because of simpler inheritance structure
	 * 
	 * @param name New name
